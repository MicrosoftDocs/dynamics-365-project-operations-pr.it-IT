...
1. In PSA fai clic su **Impostazioni** > ,**Soluzioni** e quindi su **Nuovo** per creare una nuova soluzione. 
2. Assegna un nome alla soluzione, **dimensioni di determinazione dei prezzi di \<nome dell'organizzazione>**, immetti le informazioni richieste e quindi fai clic su **Salva**.
...
1. In PSA fai clic su **Impostazioni** > **Soluzioni** e quindi fai doppio clic su **dimensioni di determinazione dei prezzi di \<nome dell'organizzazione>**.
...
## <a name="add-all-required-psa-entities-and-related-components-to-the-pricing-dimension-solution"></a>Aggiungere tutte le entità PSA necessarie e i componenti correlati alla soluzione per le dimensioni di determinazione dei prezzi
Devi aggiungere le seguenti entità di Project Service alla soluzione per la determinazione dei prezzi. Utilizza i passaggi in questa procedura per apportare alcune importanti modifiche allo schema nella soluzione per la determinazione dei prezzi di modo che le entità siano consapevoli delle nuove dimensioni di determinazione dei prezzi.
...
4. Quando viene richiesto di includere le entità dipendenti per le entità selezionate sopra, fai clic su **No**.
