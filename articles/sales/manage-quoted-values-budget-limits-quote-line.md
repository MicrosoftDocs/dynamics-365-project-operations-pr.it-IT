...
description: In questo articolo vengono fornite informazioni sull'utilizzo di righe di offerta di progetto per il lavoro di progetto.
author: rumant
ms.date: 10/01/2020
ms.topic: overview
