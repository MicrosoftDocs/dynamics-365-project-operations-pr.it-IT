...
description: Questo articolo fornisce esempi dei contratti di progetto che puoi creare per vari tipi di progetti e fonti di finanziamento, e come puoi gestire i contratti e inviare fattura ai clienti del progetto.
author: Yowelle
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
...
In Dynamics 365 Finance è possibile suddividere la fatturazione per una singola transazione o un intero progetto tra più clienti, contributi o organizzazioni. 
