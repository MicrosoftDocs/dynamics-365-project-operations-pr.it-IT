...
description: In questo articolo vengono fornite informazioni sull'impostazione e la gestione dei termini di ritenuta per pagamenti fornitore.
author: Yowelle
ms.date: 05/26/2020
ms.topic: article
ms.prod: ''
