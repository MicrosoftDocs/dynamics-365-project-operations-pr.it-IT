...
description: Questo argomento fornisce informazioni sull'impatto sulla tabella Valori effettivi in vari eventi per un progetto interno in Microsoft Dynamics 365 Project Operations.
author: rumant
ms.date: 02/22/2022
ms.topic: overview
ms.prod: ''
