...
description: Questo argomento fornisce informazioni sull'impatto sulla tabella Valori effettivi in vari eventi durante il ciclo di vita di un impegno di prezzo fisso in Microsoft Dynamics 365 Project Operations.
author: rumant
ms.date: 02/22/2022
ms.topic: overview
ms.prod: ''
