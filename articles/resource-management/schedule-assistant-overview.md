...
description: In questo articolo vengono fornite informazioni sull'utilizzo dell'assistente di pianificazione per prenotare le risorse.
author: ruhercul
ms.date: 10/01/2020
ms.topic: overview
