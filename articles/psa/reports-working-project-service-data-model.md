...
description: In questo articolo vengono fornite informazioni su come utilizzare il modello di dati.
author: ruhercul
ms.custom:
...
Dynamics 365 Project Service Automation estende le entità di altre app e introduce le proprie entità nel modello di dati di Common Data Service. In questo articolo vengono descritte alcune delle entità utilizzate in scenari di creazione di report PSA tipici.
