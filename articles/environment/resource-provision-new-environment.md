...
| **Libro mastro (msdyn_ledgers)** | No | Sì | App Finance and Operations | Sì | Sì, app Finance and Operations |
...
| **Entità di esportazione categorie delle spese di progetto di integrazione di Project Operations (msdyn\_expensecategories)** | No | No | N/A | No | N/A |
