...
---
# <a name="importing-estimates-for-a-project-to-a-project-based-quote-line"></a>Importazione delle stime per un progetto su una riga di offerta basata su progetto
